...
with DAG(
    ...
    t1_send_email = EmailOperator(
        ...
        to=E_MAIL,
        subject="Сегодня - {{data_interval_end.strftime('%d.%m.%Y')}}. Задача-1",
        html_content="""
        <h2>mg: Сегодня - {{data_interval_end.strftime('%d.%m.%Y')}}.  Задача-1 !</h2>
        """,
    )
    ...
    t2_send_email = EmailOperator(
        ...
        conn_id="smtp_angstrem",
        to=E_MAIL,
        subject="Сегодня - {{data_interval_end.strftime('%d.%m.%Y')}}. Задача-2",
        html_content="""
        <h2>mg: Сегодня - {{data_interval_end.strftime('%d.%m.%Y')}}.  Задача-2 !</h2>
        """,
    )
